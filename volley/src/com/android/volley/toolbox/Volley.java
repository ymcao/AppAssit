...
public class Volley {
	 ...
	 */
	public static RequestQueue newRequestQueue(Context context, File file, HttpStack stack) {
		File cacheDir = new File(file, DEFAULT_CACHE_DIR);
	...
	public static RequestQueue newRequestQueue(Context context, File file) {
		return newRequestQueue(context, file, null);
	}
}
