...
public class SharedPrefUtil {
	...
	public static boolean getBoolean(String key, boolean defaultValue) {
		SharedPreferences pref = SLAppication.getContext().getSharedPreferences(Const.CONFIG_NAME, Context.MODE_PRIVATE);
	...
	public static void putBoolean(String key, Boolean value) {
		SharedPreferences.Editor editor = SLAppication.getContext().getSharedPreferences(Const.CONFIG_NAME, Context.MODE_PRIVATE).edit();
