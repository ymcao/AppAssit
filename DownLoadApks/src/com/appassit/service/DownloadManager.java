...
public class DownloadManager {
	...
	public DownloadInfo getDownloadInfo(String downloadurl) {
		if (downloadInfoList != null && downloadInfoList.size() > 0) {
			for (int i = 0; i < downloadInfoList.size(); i++) {
				if (downloadInfoList.get(i).getDownloadUrl().equals(downloadurl))
	...
	public DownloadInfo getDownloadInfo(int index) {
		if (downloadInfoList != null && downloadInfoList.size() > 0 && index < downloadInfoList.size()) {
	...
	public void addNewDownload(String url, String iconpath, String fileName, String target, boolean autoResume, boolean autoRename,
