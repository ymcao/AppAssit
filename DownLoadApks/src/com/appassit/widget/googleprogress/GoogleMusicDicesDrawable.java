package com.appassit.widget.googleprogress;
...
public class GoogleMusicDicesDrawable extends Drawable implements Drawable.Callback {
	...
	private void init() {
		...
		mDiceStates = new DiceState[] { new DiceState(DiceSide.ONE, DiceSide.THREE), new DiceState(DiceSide.TWO, DiceSide.THREE),
				new DiceState(DiceSide.TWO, DiceSide.SIX), new DiceState(DiceSide.FOUR, DiceSide.SIX), new DiceState(DiceSide.FOUR, DiceSide.FIVE),
