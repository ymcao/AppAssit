...
public class BitmapGlobalConfig {
	...
	public final static int MIN_MEMORY_CACHE_SIZE = 1024 * 1024 * 4; // 4M
	private int memoryCacheSize = 1024 * 1024 * 10; // 8MB
	public final static int MIN_DISK_CACHE_SIZE = 1024 * 1024 * 20; // 20M
	...
	private int defaultConnectTimeout = 1000 * 10; // 15 sec
	private int defaultReadTimeout = 1000 * 10; // 15 sec
